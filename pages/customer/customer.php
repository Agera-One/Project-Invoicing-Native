                        ...
                        <nav aria-label="Page navigation example" class="m-0">
                            <ul class="pagination pagination-sm m-0">
                                <?php if ($pagination['active_page'] > 1): ?>
                                    <li class="page-customer">
                                        <a class="page-link" href="?page=<?= $pagination['active_page'] - 1 ?><?= $search ? '&search=' . urlencode($search) : '' ?>">Previous</a>
                                    </li>
                                <?php else: ?>
                                    <li class="page-customer disabled"><span class="page-link">Previous</span></li>
                                <?php endif; ?>

                                <?php for ($i = 1; $i <= $pagination['total_page']; $i++): ?>
                                    <li class="page-customer <?= ($i == $pagination['active_page']) ? 'active' : '' ?>">
                                ...
                                <?php else: ?>
                                    <li class="page-customer disabled"><span class="page-link">Next</span></li>
                                <?php endif; ?>
                            </ul>
                        </nav>
                    </div>
